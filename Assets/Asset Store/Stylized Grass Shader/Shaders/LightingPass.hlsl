...
// Unity 6+ uses GBufferOutput.hlsl instead of UnityGBuffer.hlsl
...
Varyings LitPassVertex(Attributes input)
{
	...
	// Unity 6 and newer versions use 2-parameter OUTPUT_SH
...
// Unity 6+ uses GBufferFragOutput instead of FragmentOutput
#if UNITY_VERSION >= 600000
...
#endif
{
	...
	// Unity 6+ uses PackGBuffersBRDFData instead of BRDFDataToGbuffer
	#if UNITY_VERSION >= 600000
